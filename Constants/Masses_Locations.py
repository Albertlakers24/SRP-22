...
LEMAC = 12.299883904659206  # LEMAC position                    [m]
xcg_gear = 13.4             # Location landing gear             [m]
xcg_aft_potato = 13.277600945954427       # Aft cg location (potato plot)     [m]
xcg_front_potato = 12.377020685031704    # Front cg location (potato plot)   [m]
cg_tank = 1.3
