...
from Constants.Aerodynamics import R_lfus, CL_Alpha_VT, Cl_Alpha_VT_Airfoil, CD0_CR,CL_DesCruise
...
print("Side slip angle =", beta, "should be > 0")        # TODO: positive sideslip angle should mean positive rudder deflection!
